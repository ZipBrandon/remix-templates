...
declare type routeRegexType = RegExp | ((options: FlatRoutesOptions) => RegExp);
...
export declare function isIndexRoute(routeId: string, options: FlatRoutesOptions): boolean;
...
export declare function getRouteSegments(name: string, index: boolean, paramPrefixChar?: string, nestedFolderChar?: string): string[];
